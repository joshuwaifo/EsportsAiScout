...
const specialMoves: SpecialMove[] = [
  {
    ...
    videoUrl: "https://www.youtube.com/embed/jtWeKFOvx9M", // Complete Ryu Hadouken Guide In Street Fighter 6
    inputs: [
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/jhcCUc0_QeA", // How To: RYU - Specials, Normals, Cancels, and Combos!
    inputs: [
      { direction: "↓", description: "Press Down", icon: "↓" },
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/LIvk9RBnHcI", // MUST Use Input For IMMEDIATE Anti Air Shoryuken Improvement
    inputs: [
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/taX4pGZIg3o", // Guile's Sonic Boom Loops For DUMMIES (Street Fighter 6 Guide)
    inputs: [
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/mnfK-QBOz5Y", // Zangief SPD Quick Guide Street Fighter 6 - Screw Piledriver Guide
    inputs: [
