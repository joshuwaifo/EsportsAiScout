...
import { FullReportGenerationDialog } from "./StrategyUtils";
import { teamAttributes } from "@/data/mockData";
    ...
    <>
      <Card className="overflow-hidden shadow-lg bg-surface bg-opacity-50 border-none">
        <CardContent className="p-6">
          ...
          <Button 
            className="flex items-center justify-center w-full px-4 py-3 mt-4"
